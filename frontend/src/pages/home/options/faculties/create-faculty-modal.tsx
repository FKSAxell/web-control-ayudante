...
export interface CreateFacultyModalState {
    codigo: string
    nombre: string
}

export default class CreateFacultyModal extends React.Component<
    CreateFacultyModalProps,
    CreateFacultyModalState
> {
    ...
    onCreateButtonClicked = async (event: React.FormEvent) => {
        ...
        try {
            ...
            await Backend.createFaculty(this.props.auth.token || '', {
